...
function MadnessifySelect({ options, placeholder, value, onValueChange }: Props) {
  const renderValue = (value: any) => {
    return options.find((v) => v.value === value)?.label || placeholder;
  };
...
export default MadnessifySelect;
